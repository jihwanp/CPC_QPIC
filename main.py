...
def get_args_parser():
    ...
    parser.add_argument('--pretrained', type=str, default='params/detr-r50-pre-hico-multipath.pth',
    ...
    parser.add_argument('--obj_consistency_loss_coef', default=1, type=float)
    parser.add_argument('--verb_consistency_loss_coef', default=1, type=float)
    parser.add_argument('--reg_consistency_loss_coef', default=2.5, type=float)
    parser.add_argument('--hoi_consistency_loss_coef',default = 0.2 , type=float)
   

    parser.add_argument('--eos_coef', default=0.1, type=float,
                        help="Relative classification weight of the no-object class")
    parser.add_argument('--ramp_up_epoch',default=30,type=int)
    parser.add_argument('--ramp_down_epoch',default=90,type=int)
    ...
    parser.add_argument('--output_dir', default='checkpoints/hicodet/',
    ...
    parser.add_argument('--project_name', default='qpic_cpc')
...
def main(args):
    ...
    if args.eval:
        if args.hoi:
            test_stats = evaluate_hoi(args.dataset_file, model, postprocessors, data_loader_val, args.subject_category_id, device,args.path_id)
            return
        else:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            model, criterion, data_loader_train, optimizer, device,args.epochs, epoch,args.ramp_up_epoch,args.ramp_down_epoch,args.hoi_consistency_loss_coef,args.clip_max_norm,args.wandb,args.use_consis)
        lr_scheduler.step()

        if args.hoi:
            test_stats = evaluate_hoi(args.dataset_file, model, postprocessors, data_loader_val, args.subject_category_id, device,args.path_id,args.wandb)
