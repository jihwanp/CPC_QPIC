...
def build(args):
    ...
    if args.hoi:
        ...
        if args.use_consis:
            weight_dict['loss_verb_consistency'] = args.verb_consistency_loss_coef
            weight_dict['loss_obj_consistency']=args.obj_consistency_loss_coef
            weight_dict['loss_sub_reg_consistency'] = args.reg_consistency_loss_coef
            weight_dict['loss_obj_reg_consistency'] = args.reg_consistency_loss_coef
